            ...
            throws ServletException, IOException 
    {
        ...
        if(formaDePago.equals("tarjetaCredito"))
        {
            htmlPago = "<form>" +
                       ...
                       "<input type=\"number\" name=\"tarjeta\" placeholder=\"Num. tarjeta\" min=\"0\" max=\"10000000000000000\" required><br>" +
        ...
        {
            htmlPago = "<h1>Pago con deposito bancario</h1>" + 
        ...
        {
            htmlEnvio = "<h1>Envio con gastos</h1>" + 
                        "<br><h2>Costo: $350</h2>";
        }
        else if(formaDeEnvio.equals("paqueteria"))
        {
            htmlEnvio = "<h1>Envio por paqueteria</h1>";
        }
